...
public class WinningNumbersSchedulerGeneratorFacadeTest {
    ...
    public void it_should_throw_an_exception_when_number_not_in_range() {
        ...
        // then
        assertThrows(IllegalStateException.class, numbersGenerator::generateWinningNumbers, "Number of range!");
    }
